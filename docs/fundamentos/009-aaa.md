...
```
 ...
 "Conhecer um nome de usuário não comprova identidade"
...
> Permitir acesso ao relatório financeiro somente para membros do Financeiro, em dispositivo gerenciado e durante o horário aprovado.
 ...
 "Permissão concedida não deve ser eterna"
...
- tratados de acordo com privacidade e requisitos legais.
 ...
 "Logs não garantem autoria absoluta"
...
| Accounting | Registros de sessões e atividades | Auditoria de operações administrativas |
 ...
 "Protocolos precisam de implantação segura"
...
```
 ...
 "Os campos dependem da fonte de dados"
...
Questão "1. Qual etapa confirma a identidade de Carlos?"
    A autenticação, realizada com a validação da senha e do segundo fator.

Questão  "2. A autenticação garante que foi realmente Carlos quem utilizou a conta?"
...
Questão  "3. Qual etapa bloqueia o painel administrativo?"
    A autorização, porque a função de Carlos não deveria possuir essa permissão.

Questão  "4. Qual componente registra a tentativa negada e a exportação?"
    O Accounting, por meio de logs e trilhas de auditoria.

Questão  "5. Por que o dispositivo desconhecido aumenta o risco?"
    Porque representa uma mudança de contexto e pode indicar uso indevido da conta.

Questão  "6. O que o SOC deveria investigar?"
...
No próximo capítulo, vamos estudar **Criptografia, hash e assinatura digital** e entender como esses mecanismos protegem a confidencialidade, a integridade e a autenticidade das informações.

[← Capítulo anterior: Zero Trust](008-zero-trust.md){ .md-button }

[Próximo: Criptografia, hash e assinatura digital →](010-criptografia-hash-assinatura-digital.md){ .md-button .md-button--primary }
